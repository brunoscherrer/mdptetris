function [w, A, b] = llsqfast(samples, policy, new_policy, firsttime)
  ...
  A = Phihat' * (Phihat - policy.lambda * new_policy.discount * PiPhihat);
  b = Phihat' * (Rhat + (1 - policy.lambda) * new_policy.discount * PiPhihat * policy.weights);
