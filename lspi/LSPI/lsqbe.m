function [w, A, b] = lsqbe(samples, policy, new_policy)
...
% 
%
% [w, A, b] = lsqbe(samples, policy, new_policy)
%
...
% linear system Aw=b. 
%
% See also lsqbefast.m for a faster implementation.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  for i=1:howmany
    ...
    A = A + (phi - new_policy.discount * nextphi2) ...
	  * (phi - new_policy.discount * nextphi)';
    b = b + (phi - new_policy.discount * nextphi2) * samples(i).reward;
