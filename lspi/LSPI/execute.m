...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  empty_result.reward2 = 0.0;
  empty_result.nextstate2 = empty_result.state;
  empty_result.absorb2 = 0;
  ...
  %%% Run the episode
  while ( (steps < maxsteps) & (~endsim) & (~endsim2) )
    ...
    [nextstate2, reward2, endsim2] = feval(simulator, state, action);
    ...
    results(steps).reward = reward2;
    results(steps).nextstate = nextstate2;
    results(steps).absorb = endsim2;
