function [w, A, b] = llsq(samples, policy, new_policy)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  disp(['Lambda: ' num2str(policy.lambda)]);
  ...
  for i=1:howmany
    ...
    A = A + phi * (phi - new_policy.discount * policy.lambda * nextphi)';
    b = b + phi * (samples(i).reward + (1 - policy.lambda) * new_policy.discount * nextphi' * policy.weights);
